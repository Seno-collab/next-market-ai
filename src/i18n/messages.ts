...
export const messages = {
  vi: {
    ...
    adminHero: {
      badge: "AI SECURITY GRID",
      title: "Điều hành khách sạn & nhà hàng kiểu hologram",
      subtitle:
        "Bảng điều khiển tương lai cho phòng, nhà hàng và QR khách với robot AI, hologram và Three.js để trực quan hóa mọi dữ liệu.",
      primaryAction: "Mở menu khách",
      secondaryAction: "Kiểm tra bảo mật",
      note: "Robot canh gác + QR phát sáng xác thực mọi lệnh quản trị.",
      securityLabel: "HOLOGRAM XÁC THỰC",
      holoTitle: "Robot sẵn sàng",
      qrLabel: "QR bảo mật",
      qrStatus: "Đã cấp quyền",
      uptimeLabel: "Thời gian chạy",
      footprintLabel: "Khách sạn + nhà hàng",
      footprintSubtitle: "Tài sản đang online",
      loginTitle: "Login nhanh",
      loginSubtitle: "Đăng nhập quản trị chỉ với 1 bước.",
      loginEmail: "admin@qrmenu.io",
      loginPassword: "••••••••",
    ...
    login: {
      ...
      title: "Đăng nhập với AI + QR bảo mật",
      subtitle: "Dùng tài khoản hoặc quét QR phát sáng để vào bảng điều khiển quản trị.",
      cta: "Đăng nhập",
      secondaryHint: "Ưu tiên QR? Quét panel bên phải để ghép nối an toàn.",
  ...
  en: {
    ...
    adminHero: {
      badge: "AI SECURITY GRID",
      title: "Holographic ops for hotels & restaurants",
      subtitle:
        "Run rooms, restaurants, and guest QR access from a cyberpunk control surface with AI robot oversight and a live 3D hologram.",
      primaryAction: "Open customer menu",
      secondaryAction: "Run security check",
      note: "Robot guardian + glowing QR authorization keeps every change verified.",
      securityLabel: "AI AUTH HOLOGRAM",
      holoTitle: "Robot guardian online",
      qrLabel: "QR clearance",
      qrStatus: "Authorized",
      uptimeLabel: "Uptime",
      footprintLabel: "Hotels + restaurants",
      footprintSubtitle: "Live properties",
      loginTitle: "Quick login",
      loginSubtitle: "Admin access in a single step.",
      loginEmail: "admin@qrmenu.io",
      loginPassword: "••••••••",
      loginButton: "Sign in",
    },
    ...
    login: {
      ...
      title: "Sign in with AI + QR security",
      subtitle: "Use your account or scan the glowing QR panel to enter the admin console.",
      cta: "Sign in",
      secondaryHint: "Prefer QR? Scan the panel on the right to pair securely.",
      ...
      visualCaption: "Robot guardian + QR badge keep every session verified.",
    },
    logout: {
