      ...
      <div className="tx-header">
        <div>
          ...
          <p className="tx-subtitle">
            Track every trade you&apos;ve recorded — BUY &amp; SELL.
          </p>
        </div>
      </div>
      ...
      <div className="tx-kpi-row">
        <div className="tx-kpi-card tx-kpi-blue">
          ...
          <div className="tx-kpi-sub">
            {kpi.buys} buys · {kpi.sells} sells on page
          </div>
        </div>
          ...
          {loading && safeRows.length === 0 ? (
            ...
            <div className="tx-empty">
              ...
              <p className="tx-empty-hint">
                Hit <strong>New Trade</strong> to record your first entry.
              </p>
            </div>
          ) : (
