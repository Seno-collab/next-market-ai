                  ...
                  <>
                    <div className="tpr-avatar-wrap">
                      ...
                      {profileAvatarSrc ? (
                        ...
                        <div className="tpr-avatar-fallback">
                          {profileInitial}
                        </div>
                      )}
                      <button
                  ...
                  {TRADER_STATS.map((s) => (
                    ...
                    >
                      <div
                        ...
                        style={
                          { "--tpr-accent": s.color } as React.CSSProperties
                        }
                      >
                        <div
                          className="tpr-stat-icon"
                          style={{ color: s.color }}
                        >
                          {s.icon}
                        </div>
                        <div
                          className="tpr-stat-val"
                          style={{ color: s.color }}
                        >
                          {s.value}
                        </div>
          ...
          <Row gutter={[GRID_GUTTER, GRID_GUTTER]}>
            <Col xs={24} sm={24} md={12} lg={12} xl={12} xxl={12}>
              ...
              <div className="tpr-panel">
                ...
                {profileError && (
                  <div className="tpr-feedback tpr-feedback-err">
                    {profileError}
                  </div>
                )}
              </div>
              ...
              <div className="tpr-panel">
                ...
                >
                  ...
                  <Form.Item
                    ...
                    name="newPassword"
                    rules={[
                      { required: true, message: t("profile.newPassword") },
                    ]}
                    className="tpr-form-item"
                  >
                    <Input.Password
