...
export default function AnalysisPage() {
  ...
  const [decisionMode, setDecisionMode] = useState<TradeDecisionMode>("hybrid");
  ...
  const fetchAnalysis = useCallback(async () => {
    ...
    try {
      setA(
        await analysisApi.getAnalysis(symbol, interval, aRef.current.signal),
      );
    } catch (e) {
  ...
  const candleColumns: TableColumnsType<CandleTableRow> = [
    ...
    },
    {
      ...
      render: (value: string, row) => (
        <span className={`al-td-num ${row.up ? "al-up" : "al-dn"}`}>
          {value}
        </span>
      ),
    },
  ...
  return (
    <div className="al-shell">
      ...
      <div className="al-toolbar">
        <div className="al-toolbar-left">
          <div className="al-eyebrow">
            <ThunderboltOutlined /> AI ANALYSIS
          </div>
        ...
        <>
          ...
          >
            ...
            <div className="al-cmd-sig">
              <div
                className="al-sig-icon"
                style={{
                  color: SIG_CLR[analysis.signal],
                  borderColor: SIG_BORDER[analysis.signal],
                  background: SIG_BG[analysis.signal],
                }}
              >
                {analysis.signal === "BUY" ? (
                  <ArrowUpOutlined />
              ...
              <div
                className="al-sig-label"
                style={{ color: SIG_CLR[analysis.signal] }}
              >
                {analysis.signal}
              </div>
            ...
            <div className="al-cmd-summary">
              <div className="al-summary-hd">
                <DotChartOutlined /> AI Summary
              </div>
          ...
          <div className="al-ind-grid">
            ...
            >
              <div className="al-ic-hd">
                ...
                <Chip
                  label={analysis.indicators.rsi.signal}
                  t={tone(
              ...
              <div className="al-rsi-wrap">
                <div className="al-rsi-track">
                  ...
                  <div
                    className="al-rsi-needle"
                    style={{ left: `${analysis.indicators.rsi.value}%` }}
                  />
                </div>
            ...
            >
              <div className="al-ic-hd">
                ...
                <Chip
                  label={analysis.indicators.macd.trend}
                  t={
                    analysis.indicators.macd.trend === "BULLISH"
                      ? "buy"
                      : "sell"
              ...
              <div className="al-ic-rows">
                <div className="al-ic-row">
                  <span className="al-ic-k">MACD</span>
                  <span className="al-ic-v">
                    {analysis.indicators.macd.macd.toFixed(2)}
                  </span>
                </div>
                <div className="al-ic-row">
                  <span className="al-ic-k">Signal</span>
                  <span className="al-ic-v">
                    {analysis.indicators.macd.signal.toFixed(2)}
                  </span>
                </div>
                <div className="al-ic-row">
                  <span className="al-ic-k">Histogram</span>
                  <span
                    className={`al-ic-v ${analysis.indicators.macd.histogram >= 0 ? "al-up" : "al-dn"}`}
                  >
                    {analysis.indicators.macd.histogram >= 0 ? "+" : ""}
                    {analysis.indicators.macd.histogram.toFixed(2)}
                  </span>
                </div>
              </div>
            </div>
            ...
            >
              <div className="al-ic-hd">
                ...
                <Chip
                  label={analysis.indicators.ema.trend}
                  t={
                    analysis.indicators.ema.trend === "BULLISH" ? "buy" : "sell"
                  }
                />
              </div>
              <div className="al-ic-rows">
                <div className="al-ic-row">
                  <span className="al-ic-k">EMA 20</span>
                  <span className="al-ic-v al-up">
                    {fmtP(analysis.indicators.ema.ema_20)}
                  </span>
                </div>
                <div className="al-ic-row">
                  <span className="al-ic-k">EMA 50</span>
                  <span className="al-ic-v">
                    {fmtP(analysis.indicators.ema.ema_50)}
                  </span>
                </div>
                <div className="al-ic-row">
                  <span className="al-ic-k">Spread</span>
                  <span
                    className={`al-ic-v ${analysis.indicators.ema.trend === "BULLISH" ? "al-up" : "al-dn"}`}
                  >
                    {analysis.indicators.ema.trend === "BULLISH" ? "▲ " : "▼ "}
                    {Math.abs(
                      analysis.indicators.ema.ema_20 -
                        analysis.indicators.ema.ema_50,
            ...
            <div
              ...
              style={
                {
                  "--ic-accent":
                    analysis.indicators.bollinger.signal === "OVERSOLD"
                      ? "#34d399"
                      : analysis.indicators.bollinger.signal === "OVERBOUGHT"
                        ? "#f87171"
                        : "#94a3b8",
                } as React.CSSProperties
              }
            >
              <div className="al-ic-hd">
                ...
                <Chip
                  label={analysis.indicators.bollinger.signal}
                  t={tone(
              ...
              <div className="al-bb">
                <div className="al-bb-row al-bb-upper">
                  <span className="al-ic-k">Upper ↑</span>
                  <span className="al-ic-v al-dn">
                    {fmtP(analysis.indicators.bollinger.upper)}
                  </span>
                </div>
                <div className="al-bb-divider" />
                <div className="al-bb-row al-bb-mid">
                  <span className="al-ic-k">Middle</span>
                  <span className="al-ic-v">
                    {fmtP(analysis.indicators.bollinger.middle)}
                  </span>
                </div>
                <div className="al-bb-divider" />
                <div className="al-bb-row al-bb-lower">
                  <span className="al-ic-k">Lower ↓</span>
                  <span className="al-ic-v al-up">
                    {fmtP(analysis.indicators.bollinger.lower)}
                  </span>
                </div>
              </div>
              <div className="al-bb-width-row">
                ...
                <span className="al-ic-v">
                  {fmtP(
                    analysis.indicators.bollinger.upper -
                      analysis.indicators.bollinger.lower,
                  )}
                </span>
              </div>
            </div>
            ...
            <div
              ...
              style={
                {
                  "--ic-accent":
                    analysis.indicators.volume.trend === "HIGH"
                      ? "#34d399"
                      : analysis.indicators.volume.trend === "LOW"
                        ? "#f87171"
                        : "#94a3b8",
                } as React.CSSProperties
              }
            >
              <div className="al-ic-hd">
                ...
                <Chip
                  label={analysis.indicators.volume.trend}
                  t={tone(analysis.indicators.volume.trend, "HIGH", "LOW")}
                />
              </div>
              <div className="al-ic-big">
                {Number(analysis.indicators.volume.current).toLocaleString(
                  "en-US",
              ...
              <div className="al-vol-compare">
                ...
                <div className="al-vol-row">
                  ...
                  <div className="al-vol-bar-bg">
                    <div
                      className="al-vol-bar-fg al-vol-avg"
                      style={{
            ...
            <div
              className="al-ic"
              style={{ "--ic-accent": "#22d3ee" } as React.CSSProperties}
            >
              <div className="al-ic-hd">
              ...
              <div className="al-hours">
                {analysis.best_hours.slice(0, 3).map((h, i) => (
                  <div key={h} className="al-hr">
                    ...
                    <span className="al-hr-t">
                      {String(h).padStart(2, "0")}:00 UTC
                    </span>
                    <div className="al-hr-bg">
                      <div
                        className="al-hr-fill"
                        style={{ width: `${[100, 72, 48][i]}%` }}
                      />
                    </div>
                  </div>
                ))}
          ...
          <div className="al-sr-row">
            ...
            <div className="al-panel al-resist-panel">
              <div className="al-panel-hd">
                <span className="al-panel-title">
                  <FallOutlined /> Resistance Levels
                </span>
      ...
      <div className="al-panel">
        <div className="al-panel-hd">
          <span className="al-panel-title">
            <LineChartOutlined /> Daily Report
          </span>
          ...
          <>
              ...
              >
                <div className="al-decision-head">
                  ...
                  <div className="al-decision-badges">
                    <Chip label={report.decision.mode.toUpperCase()} t="hold" />
                    <Chip
                ...
                <div className="al-decision-grid">
                  ...
                  <div className="al-dm-row">
                    ...
                    <span className="al-dm-v">
                      {report.decision.analysis_signal}
                    </span>
                  </div>
                  <div className="al-dm-row">
            ...
            <div className="al-ticker-row">
              {[
                {
                  label: "Last Price",
                  val: `$${fmtP(report.ticker.last_price)}`,
                  cls: "",
                },
                {
                  label: "24h Change",
                  ...
                  cls:
                    Number(report.ticker.price_change_percent) >= 0
                      ? "al-up"
                      : "al-dn",
                },
                {
                  label: "High",
                  val: `$${fmtP(report.ticker.high_price)}`,
                  cls: "al-up",
                },
                {
                  label: "Low",
                  val: `$${fmtP(report.ticker.low_price)}`,
                  cls: "al-dn",
                },
                {
                  label: "Open",
                  val: `$${fmtP(report.ticker.open_price)}`,
                  cls: "",
                },
                {
                  label: "Volume",
                  val: Number(report.ticker.volume).toLocaleString("en-US", {
                    notation: "compact",
                    maximumFractionDigits: 1,
                  }),
                  cls: "",
