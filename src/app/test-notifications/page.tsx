...
export default function TestNotificationsPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-liner-to-br from-slate-900 to-slate-800 p-8">
      <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-8 max-w-md w-full">
        ...
        <p className="text-slate-400 mb-8">
          Click the buttons below to test the holographic toast notifications
          with 3D effects.
        </p>
        ...
        <div className="mt-8 p-4 bg-slate-900/50 rounded-lg">
          ...
          <ul className="text-xs text-slate-400 space-y-1">
            <li>
              ✨ <strong>Success:</strong> Cyan floating particles drifting
              upward
            </li>
            <li>
              🔴 <strong>Error:</strong> Red pulsing glow effect
            </li>
            <li>
              ⚠️ <strong>Warning:</strong> Amber shimmer on edges
            </li>
          </ul>
        </div>

        <p className="mt-6 text-xs text-slate-500 text-center">
          Effects are subtle and non-intrusive. Open DevTools to check
          performance.
        </p>
      </div>
    </div>
