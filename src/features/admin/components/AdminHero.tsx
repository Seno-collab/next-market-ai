...
export function AdminHero() {
  ...
  return (
    <Card
      className="glass-card hero-card dashboard-hero-card"
      variant="borderless"
    >
      <Row gutter={[32, 32]} align="middle">
        <Col xs={24} lg={14}>
          <Space orientation="vertical" size="middle">
            <Tag className="neon-tag dashboard-badge">
              {t("adminHero.badge")}
            </Tag>
            ...
            <div className="holo-stage-wrap">
              <div className="holo-chip-grid">
                <div className="holo-chip">
                  <span className="holo-chip-label">
                    {t("adminHero.holoTitle")}
                  </span>
                  <strong>99.98%</strong>
                  <span className="holo-chip-sub">
                    {t("adminHero.uptimeLabel")}
                  </span>
                </div>
                ...
                <div className="holo-chip">
                  <span className="holo-chip-label">
                    {t("adminHero.footprintLabel")}
                  </span>
                  <strong>48</strong>
                  <span className="holo-chip-sub">
                    {t("adminHero.footprintSubtitle")}
                  </span>
                </div>
              </div>
            </div>
